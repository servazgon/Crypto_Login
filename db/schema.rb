...
ActiveRecord::Schema.define(version: 2018_10_19_150203) do
  ...
  create_table "cryptos", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "crypto_id"
    t.string "symbol"
    t.string "name"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["crypto_id"], name: "index_cryptos_on_crypto_id", unique: true
  end
